...
include("koneksi.php");
    ...
    if (isset($_POST["register"])) {
        ...
        $query = "SELECT * FROM userBarang WHERE email='$email'";
        ...
        if ($error_message === "") {
            ...
            $query = "INSERT INTO userBarang VALUES ";
            ...
            if($result) {
              ...
              window.location = 'loginBarang.php'
                ...
                die ("Query gagal dijalankan: ".mysqli_errno($koneksi). " - ".mysqli_error($koneksiz));
            }
        }
        ...
        <div class="row">
          <div class="col-sm rounded text-light" style="background-color: #0B56A7">
            ...
            <div align="center">
              ...
              <a href="loginBarang.php"><button class="btn btn-danger">Login</button></a>
            </div>
          </div>
        </div>
      </div>

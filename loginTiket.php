<?php
    ...
    if (isset($_POST["login"])) {
        ...
        if($count > 0){
            session_start();
            $id_pemesan = $fetchData['id_pemesan'];
            $level = $fetchData['level'];
            $nama = $fetchData['nama'];
            if($level == '1'){
                $_SESSION['id_pemesan'] = $id_pemesan;
                ...
                $_SESSION['level'] = $level;
                $_SESSION['nama'] = $nama;
                header('location:reservasiTiket.php');
            }
        }else{
          echo "<script>
      ...
      <div class="justify-content-center" style="display:flex;flex-wrap:wrap;margin-right:-15px;margin-left:-15px;">
        <div class="col-md-5 col-xs-12 col-sm-12" style="margin-top:50px">
            <div class="card" style="border-radius:5px">
                ...
                <div class="card-body">
                    <form method="POST" action="" data-toggle="validator" autocomplete="on" novalidate="false">
                        ...
                        <div class="form-group row">
                            ...
                            <div style="background-color:#e7e7e7;" class="input-group">
                                ...
                                <input id="username" type="email" class="form-control " name="email" value="<?php echo $email ?>" placeholder="Email" oninvalid="this.setCustomValidity('Harap mengisi Email')"  required>
                            </div>
...
<br>
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <div style="background-color:#e7e7e7;" class="input-group">
                                    ...
                                    <input id="password" type="password" class="form-control pass " name="password" value="<?php echo $password ?>" placeholder="Password" required="" data-error="Password wajib diisi.">
                    ...
                    <div class="row">
                        <div class="col-md-12 control">
                            <div style="border-top: 1px solid#888; padding-top:15px; font-size:85%;list-style:none;">
                            <a href="regristrasiTiket.php" style="text-decoration: none;" >
                                Registrasi</a>                           
                            </div>
                        </div>
                    </div>

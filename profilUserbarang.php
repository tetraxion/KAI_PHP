...
if (!isset($_SESSION["email"])) {
  header("Location: loginBarang.php");
}
...
$query = "SELECT * FROM userbarang WHERE id_pemesanBarang = '$id';";
...
if (isset($_POST["update"])) {
  ...
  $query = "UPDATE userbarang SET NIK = '$NIK', nama = '$nama1' WHERE id_pemesanBarang = '$id'";
  $sql = mysqli_query($koneksi, $query);

  if ($sql) {
    header("location: profilUserbarang.php");
  } else {
...
<head>
  ...
  <title>Profil User Barang</title>
      ...
      <div class="collapse navbar-collapse" id="navbarText">
        ...
        <div class="dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a class="dropdown-item" href="reservasiBarang.php">Back</a></li>
